...
class Login:
    ...
    def login_browser(self):
        ...
        import time
        logger.info("Menunggu Anda login secara manual pada jendela browser (Batas waktu 10 menit)..")
        logged_in = False
        ...
        if not logged_in:
            ...
            raise Exception("Login Timeout atau browser ditutup sebelum berhasil login")
